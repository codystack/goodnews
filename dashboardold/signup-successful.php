                ...
                <div class="card shadow">
                    <div class="card-body p-6">
                        <div class="mb-4 text-center">
                            ...
                            <p class="text-dark fw-light fs-3">Hello! <span class="fw-bold"><?php echo $_SESSION['firstName']; ?>,</span> your registration was successful, login with the correct credentials to gain access to the global financial funding. </p>
                            <a href="logout" type="button" class="btn btn-dark">Login Account</a>
                        </div>
                    </div>
                </div>
            </div>
