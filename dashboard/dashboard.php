                            ...
                            <div class="card-body inverted level-3">
                                <div class="row">
                                    <div class="col-lg-10">
                                        ...
                                        <h2 class="mt-3">Welcome, <?php echo $_SESSION['firstName']; ?>!</h2>
                                    </div>
                                </div>
                                        ...
                                        <div class="row g-3 g-xl-5">
                                                ...
                                                <a href="summit-application" class="card equal-md-4-3 card-hover-border bg-white">
                                                    <div class="card-wrap text-center">
                                                        <div class="card-header pb-0">
                                                            <img src="./assets/images/access.svg" alt="Logo" class="mb-2 w-40">
                                                        </div>
                                                        <div class="card-footer pt-0 mt-auto">
                                                            <h4 class="card-title fw-light">Access Code</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
                                            ...
                                            <div class="col-md-6" data-aos-delay="100">
                                                <a href="exhibitors-application" class="card equal-md-4-3 card-hover-border bg-white">
                                                    <div class="card-wrap text-center">
                                                        <div class="card-header pb-0">
                                                            <img src="./assets/images/pay.svg" alt="Logo" class="mb-2 w-40">
                                                        </div>
                                                        <div class="card-footer pt-0 mt-auto">
                                                            <h4 class="card-title fw-light">Pay Bills</h4>
                                                        </div>
                                                    </div>
                                                </a>
                                            </div>
